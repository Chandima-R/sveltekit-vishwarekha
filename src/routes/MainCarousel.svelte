...
<section class="bg-[url('./images/slider-image-1.jpg')] bg-cover flex flex-col m-auto" id="home">
    <div class="flex flex-col h-fits w-full pt-30 px-2 md:py-14 md:pt-36 lg:pt-44 lg:px-24 lg:w-full lg:pb-60 lg:flex-row">
        ...
        <div class="slider-cards w-full relative invisible lg:visible">
            <div class="bg-[url('./images/slider-image-1.jpg')] bg-cover bg-current w-full h-full border border-white rounded-lg shadow-xl shadow-green-900/50 absolute top-0 right-0 z-10"></div>
            <div class="bg-[url('./images/slider-image-2.jpg')] bg-cover bg-current w-full h-full border border-white rounded-lg shadow-xl shadow-green-900/50 absolute top-32 right-20 z-10"></div>
            <div class="bg-[url('./images/slider-image-3.jpg')] bg-cover bg-current w-full h-full border border-white rounded-lg shadow-xl shadow-green-900/50 absolute top-64 right-40 z-20"></div>
        </div>
    </div>
</section>
