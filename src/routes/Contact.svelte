        ...
        <div class="w-full">
            <div class="mb-5">
                ...
                <div class="mt-2 flex flex-col w-full lg:flex-row">
                    <input class="rounded-lg m-0 mb-2 p-2 w-full h-10 placeholder:italic placeholder:text-slate-400 text-md focus:outline-none text-gray-600 italic lg:w-2/5 lg:mb-0 lg:mr-4" placeholder="Email Address" />
                    <button class="w-36 rounded-lg bg-amber-400 text-green-900 py-2 px-4 border border-amber-400">Sign Up</button>
                </div>
            </div>
            <div>
